...
class ColorConstant {
  ...
  static const Color COLOR_LIGHT_BLACK = Color(0xFF424242);
  static const Color COLOR_LIGHT_GREY = Color(0xFFeeeeee);
  static const Color COLOR_WHITE = Colors.white;
  static const Color COLOR_LIGHT_GREY2 = Color(0xFFe9e7f1);
